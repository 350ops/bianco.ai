// scan3D Itemized Estimate Calculation Service
...
const LOCAL_CATALOG: CatalogItem[] = [
  ...
  {
    code: 'FLOOR_DEMO',
    name: 'Floor demolition & disposal',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 12.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_PREP',
    name: 'Floor surface preparation',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 8.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_HARDWOOD_SUPPLY',
    name: 'Hardwood flooring supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 55.0,
    defaultWastePct: 0.1,
  ...
  {
    code: 'FLOOR_HARDWOOD_LABOR',
    name: 'Hardwood installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 28.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_LAMINATE_LABOR',
    name: 'Laminate installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 18.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_TILE_SUPPLY',
    name: 'Floor tile supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 35.0,
    defaultWastePct: 0.12,
  },
  {
    code: 'FLOOR_TILE_ADHESIVE',
  ...
  {
    code: 'FLOOR_VINYL_SUPPLY',
    name: 'Vinyl flooring supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 18.0,
    defaultWastePct: 0.08,
  ...
  {
    code: 'FLOOR_VINYL_LABOR',
    name: 'Vinyl installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 15.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_CARPET_UNDERPAD',
    name: 'Carpet underpad',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 6.0,
    defaultWastePct: 0.05,
  ...
  {
    code: 'FLOOR_CARPET_LABOR',
    name: 'Carpet installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 12.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_MARBLE_SUPPLY',
    name: 'Marble flooring supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 120.0,
    defaultWastePct: 0.12,
  ...
  {
    code: 'FLOOR_MARBLE_LABOR',
    name: 'Marble installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 55.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_ENGWOOD_SUPPLY',
    name: 'Engineered wood flooring supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 42.0,
    defaultWastePct: 0.1,
  ...
  {
    code: 'FLOOR_ENGWOOD_LABOR',
    name: 'Engineered wood installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 24.0,
    defaultWastePct: 0,
  ...
  {
    code: 'FLOOR_SKIRTING_SUPPLY',
    name: 'Skirting/baseboard supply',
    unit: 'lm',
    costType: 'material',
    baseUnitCost: 8.0,
    defaultWastePct: 0.08,
  ...
  {
    code: 'FLOOR_SKIRTING_LABOR',
    name: 'Skirting installation labor',
    unit: 'lm',
    costType: 'labor',
    baseUnitCost: 6.0,
    defaultWastePct: 0,
  ...
  },
  {
    ...
    costType: 'material',
    baseUnitCost: 3.5,
    defaultWastePct: 0.07,
  },
  {
    code: 'WALL_PAINT_SUPPLY',
    name: 'Wall paint supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 4.0,
    defaultWastePct: 0.07,
  ...
  {
    code: 'WALL_PAINT_LABOR',
    name: 'Wall painting labor (2 coats)',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 8.0,
    defaultWastePct: 0,
  ...
  {
    code: 'WALL_PAPER_SUPPLY',
    name: 'Wallpaper supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 18.0,
    defaultWastePct: 0.1,
  ...
  {
    code: 'WALL_PAPER_LABOR',
    name: 'Wallpaper installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 15.0,
    defaultWastePct: 0,
  ...
  {
    code: 'WALL_TILE_SUPPLY',
    name: 'Wall tile supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 32.0,
    defaultWastePct: 0.12,
  ...
  {
    code: 'WALL_TILE_ADHESIVE',
    name: 'Wall tile adhesive & grout',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 7.0,
    defaultWastePct: 0.05,
  ...
  {
    code: 'WALL_PANEL_SUPPLY',
    name: 'Wood paneling supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 45.0,
    defaultWastePct: 0.1,
  ...
  {
    code: 'WALL_PANEL_LABOR',
    name: 'Wood paneling installation labor',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 28.0,
    defaultWastePct: 0,
  ...
  {
    code: 'WALL_BRICK_EXPOSE',
    name: 'Brick exposure work',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 35.0,
    defaultWastePct: 0,
  ...
  {
    code: 'WALL_PLASTER_SUPPLY',
    name: 'Textured plaster supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 12.0,
    defaultWastePct: 0.08,
  ...
  {
    code: 'WALL_PLASTER_LABOR',
    name: 'Textured plaster application',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 22.0,
    defaultWastePct: 0,
  ...
  {
    code: 'WALL_STONE_SUPPLY',
    name: 'Stone veneer supply',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 65.0,
    defaultWastePct: 0.1,
  ...
  // Built-ins
  {
    code: 'BUILTIN_BASIC_CABINET',
    name: 'Basic cabinet supply',
    unit: 'lm',
    costType: 'material',
    baseUnitCost: 180.0,
    defaultWastePct: 0,
  ...
  {
    code: 'BUILTIN_BASIC_INSTALL',
    name: 'Basic cabinet installation',
    unit: 'lm',
    costType: 'labor',
    baseUnitCost: 85.0,
    defaultWastePct: 0,
  ...
  {
    code: 'BUILTIN_SHELF_SUPPLY',
    name: 'Built-in shelving supply',
    unit: 'lm',
    costType: 'material',
    baseUnitCost: 65.0,
    defaultWastePct: 0,
  ...
  {
    code: 'BUILTIN_VANITY_SUPPLY',
    name: 'Bathroom vanity supply',
    unit: 'item',
    costType: 'material',
    baseUnitCost: 450.0,
    defaultWastePct: 0,
  ...
  {
    code: 'BUILTIN_ENTERTAIN_INSTALL',
    name: 'Entertainment center installation',
    unit: 'lm',
    costType: 'labor',
    baseUnitCost: 110.0,
    defaultWastePct: 0,
  ...
  {
    code: 'BUILTIN_CUSTOM_JOINERY',
    name: 'Full custom joinery',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 450.0,
    defaultWastePct: 0,
  ...
  {
    code: 'BUILTIN_CUSTOM_INSTALL',
    name: 'Full custom installation',
    unit: 'm2',
    costType: 'labor',
    baseUnitCost: 180.0,
    defaultWastePct: 0,
  ...
  // Project-level
  {
    code: 'PROJ_SITE_SETUP',
    name: 'Site setup & protection',
    unit: 'fixed',
    costType: 'labor',
    baseUnitCost: 250.0,
    defaultWastePct: 0,
  ...
  {
    code: 'PROJ_PROTECTION',
    name: 'Surface protection materials',
    unit: 'm2',
    costType: 'material',
    baseUnitCost: 2.5,
    defaultWastePct: 0,
...
const LOCAL_ASSEMBLIES: Assembly[] = [
  // Flooring
  {
    ...
    appliesTo: 'floorFinish',
    appliesToValue: 'Hardwood',
    items: [
      ...
      {
        catalogCode: 'FLOOR_UNDERLAY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_HARDWOOD_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_HARDWOOD_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
      {
        catalogCode: 'FLOOR_SKIRTING_SUPPLY',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_SKIRTING_LABOR',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        catalogCode: 'FLOOR_LAMINATE_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_LAMINATE_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    name: 'Ceramic Tile Floor Installation',
    appliesTo: 'floorFinish',
    appliesToValue: 'Tile (Ceramic)',
    items: [
      { catalogCode: 'FLOOR_DEMO', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      { catalogCode: 'FLOOR_PREP', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      {
        catalogCode: 'FLOOR_TILE_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_TILE_ADHESIVE',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_TILE_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  {
    code: 'FLOOR_TILE_PORCELAIN',
    name: 'Porcelain Tile Floor Installation',
    appliesTo: 'floorFinish',
    appliesToValue: 'Tile (Porcelain)',
    items: [
      { catalogCode: 'FLOOR_DEMO', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      { catalogCode: 'FLOOR_PREP', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      {
  ...
  {
    code: 'FLOOR_VINYL',
    name: 'Vinyl / LVT Floor Installation',
    appliesTo: 'floorFinish',
    appliesToValue: 'Vinyl / LVT',
    items: [
      { catalogCode: 'FLOOR_DEMO', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      {
        catalogCode: 'FLOOR_VINYL_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_VINYL_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    appliesTo: 'floorFinish',
    appliesToValue: 'Carpet',
    items: [
      { catalogCode: 'FLOOR_DEMO', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      {
        catalogCode: 'FLOOR_CARPET_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_CARPET_UNDERPAD',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_CARPET_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    appliesTo: 'floorFinish',
    appliesToValue: 'Polished Concrete',
    items: [
      {
        catalogCode: 'FLOOR_CONCRETE_POLISH',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
      {
        catalogCode: 'FLOOR_CONCRETE_SEALER',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
  ...
  {
    code: 'FLOOR_MARBLE',
    name: 'Marble Floor Installation',
    appliesTo: 'floorFinish',
    appliesToValue: 'Marble',
    items: [
      { catalogCode: 'FLOOR_DEMO', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      { catalogCode: 'FLOOR_PREP', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      {
        catalogCode: 'FLOOR_MARBLE_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_MARBLE_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    appliesTo: 'floorFinish',
    appliesToValue: 'Engineered Wood',
    items: [
      { catalogCode: 'FLOOR_DEMO', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      {
        catalogCode: 'FLOOR_UNDERLAY',
      ...
      {
        catalogCode: 'FLOOR_ENGWOOD_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'FLOOR_ENGWOOD_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  {
    code: 'FLOOR_NATURAL_STONE',
    name: 'Natural Stone Floor Installation',
    appliesTo: 'floorFinish',
    appliesToValue: 'Natural Stone',
    items: [
      { catalogCode: 'FLOOR_DEMO', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      { catalogCode: 'FLOOR_PREP', qtyFormula: 'area_m2', qtyMultiplier: 1.0, includeWaste: false },
      {
  ...
  {
    code: 'FLOOR_MICROCEMENT',
    name: 'Microcement Floor Installation',
    appliesTo: 'floorFinish',
    appliesToValue: 'Microcement',
    items: [
      { catalogCode: 'FLOOR_PREP', qtyFormula: 'area_m2', qtyMultiplier: 1.5, includeWaste: false }, // More prep needed
      {
        catalogCode: 'WALL_PLASTER_SUPPLY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.3,
        includeWaste: true,
      }, // Similar to textured plaster
      {
        catalogCode: 'WALL_PLASTER_LABOR',
        qtyFormula: 'area_m2',
        qtyMultiplier: 1.5,
        includeWaste: false,
      }, // Specialized labor
  ...
  // Walls
  {
    code: 'WALL_PAINT_STANDARD',
    name: 'Wall Painting (Standard)',
    appliesTo: 'wallFinish',
    appliesToValue: 'Paint (Standard)',
    items: [
      {
        catalogCode: 'WALL_PREP',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
      {
        catalogCode: 'WALL_PRIMER',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'WALL_PAINT_SUPPLY',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 2.0,
        includeWaste: true,
      }, // 2 coats
      {
        catalogCode: 'WALL_PAINT_LABOR',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  {
    code: 'WALL_PAINT_PREMIUM',
    name: 'Wall Painting (Premium)',
    appliesTo: 'wallFinish',
    appliesToValue: 'Paint (Premium)',
    items: [
      {
        catalogCode: 'WALL_PREP',
        qtyFormula: 'wall_area_m2',
  ...
  },
  {
    ...
    items: [
      ...
      {
        catalogCode: 'WALL_PAPER_SUPPLY',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'WALL_PAPER_ADHESIVE',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'WALL_PAPER_LABOR',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        catalogCode: 'WALL_TILE_SUPPLY',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'WALL_TILE_ADHESIVE',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'WALL_TILE_LABOR',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  {
    code: 'WALL_WOOD_PANEL',
    name: 'Wood Paneling',
    appliesTo: 'wallFinish',
    appliesToValue: 'Wood Paneling',
    items: [
      {
        catalogCode: 'WALL_PREP',
        qtyFormula: 'wall_area_m2',
      ...
      {
        catalogCode: 'WALL_PANEL_SUPPLY',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'WALL_PANEL_LABOR',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  {
    code: 'WALL_EXPOSED_BRICK',
    name: 'Exposed Brick',
    appliesTo: 'wallFinish',
    appliesToValue: 'Exposed Brick',
    items: [
      {
        catalogCode: 'WALL_BRICK_EXPOSE',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
      {
        catalogCode: 'WALL_BRICK_SEAL',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
  ...
  {
    code: 'WALL_TEXTURED_PLASTER',
    name: 'Textured Plaster',
    appliesTo: 'wallFinish',
    appliesToValue: 'Textured Plaster',
    items: [
      {
        catalogCode: 'WALL_PREP',
        qtyFormula: 'wall_area_m2',
  ...
  {
    code: 'WALL_STONE_VENEER',
    name: 'Stone Veneer',
    appliesTo: 'wallFinish',
    appliesToValue: 'Stone Veneer',
    items: [
      {
        catalogCode: 'WALL_PREP',
        qtyFormula: 'wall_area_m2',
      ...
      {
        catalogCode: 'WALL_STONE_SUPPLY',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: true,
      },
      {
        catalogCode: 'WALL_STONE_LABOR',
        qtyFormula: 'wall_area_m2',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    appliesTo: 'wallFinish',
    appliesToValue: 'Acoustic Panels',
    items: [
      {
        catalogCode: 'WALL_PREP',
        qtyFormula: 'wall_area_m2',
  ...
  // Built-ins
  {
    code: 'BUILTIN_BASIC',
    name: 'Basic Cabinets',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Basic Cabinets',
    items: [
      {
        catalogCode: 'BUILTIN_BASIC_CABINET',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.3,
        includeWaste: false,
      },
      {
        catalogCode: 'BUILTIN_BASIC_INSTALL',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.3,
        includeWaste: false,
      },
  ...
  },
  {
    ...
    name: 'Custom Closets',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Custom Closets',
    items: [
      {
        catalogCode: 'BUILTIN_CLOSET_SYSTEM',
        qtyFormula: 'area_m2',
        qtyMultiplier: 0.15,
        includeWaste: false,
      },
      {
        catalogCode: 'BUILTIN_CLOSET_INSTALL',
        qtyFormula: 'area_m2',
        qtyMultiplier: 0.15,
        includeWaste: false,
      },
  ...
  {
    code: 'BUILTIN_SHELVING',
    name: 'Built-in Shelving',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Built-in Shelving',
    items: [
      {
        catalogCode: 'BUILTIN_SHELF_SUPPLY',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.25,
        includeWaste: false,
      },
      {
        catalogCode: 'BUILTIN_SHELF_INSTALL',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.25,
        includeWaste: false,
      },
  ...
  {
    code: 'BUILTIN_KITCHEN_STD',
    name: 'Kitchen Cabinets (Standard)',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Kitchen Cabinets (Standard)',
    items: [
      {
        catalogCode: 'BUILTIN_KITCHEN_CAB',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.5,
        includeWaste: false,
      },
      {
        catalogCode: 'BUILTIN_KITCHEN_INSTALL',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.5,
        includeWaste: false,
      },
  ...
  {
    code: 'BUILTIN_KITCHEN_PREM',
    name: 'Kitchen Cabinets (Premium)',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Kitchen Cabinets (Premium)',
    items: [
      {
        catalogCode: 'BUILTIN_KITCHEN_CAB',
        qtyFormula: 'perimeter_lm',
  ...
  },
  {
    ...
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Bathroom Vanity',
    items: [
      {
        catalogCode: 'BUILTIN_VANITY_SUPPLY',
        qtyFormula: 'fixed',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
      {
        catalogCode: 'BUILTIN_VANITY_INSTALL',
        qtyFormula: 'fixed',
        qtyMultiplier: 1.0,
        includeWaste: false,
      },
  ...
  {
    code: 'BUILTIN_ENTERTAINMENT',
    name: 'Entertainment Center',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Entertainment Center',
    items: [
      {
        catalogCode: 'BUILTIN_ENTERTAIN_UNIT',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.2,
        includeWaste: false,
      },
      {
        catalogCode: 'BUILTIN_ENTERTAIN_INSTALL',
        qtyFormula: 'perimeter_lm',
        qtyMultiplier: 0.2,
        includeWaste: false,
      },
  ...
  {
    code: 'BUILTIN_HOME_OFFICE',
    name: 'Home Office Desk & Storage',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Home Office Desk & Storage',
    items: [
      {
        catalogCode: 'BUILTIN_SHELF_SUPPLY',
        qtyFormula: 'perimeter_lm',
  ...
  {
    code: 'BUILTIN_FULL_CUSTOM',
    name: 'Full Custom Joinery',
    appliesTo: 'builtInFurniture',
    appliesToValue: 'Full Custom Joinery',
    items: [
      {
        catalogCode: 'BUILTIN_CUSTOM_JOINERY',
        qtyFormula: 'area_m2',
        qtyMultiplier: 0.25,
        includeWaste: false,
      },
      {
        catalogCode: 'BUILTIN_CUSTOM_INSTALL',
        qtyFormula: 'area_m2',
        qtyMultiplier: 0.25,
        includeWaste: false,
      },
...
const WALL_OPENINGS_PCT = 0.1; // 10% for doors/windows
...
const getLocationFactor = (location: string, costType: string): number => {
  ...
  if (location === 'Brazil') {
    return costType === 'labor' ? 0.65 : costType === 'material' ? 0.8 : 0.75;
  }
  if (location === 'Other') {
    return costType === 'labor' ? 1.15 : costType === 'material' ? 1.08 : 1.1;
  }
  return 1.0; // Spain
};
...
const calculateQuantity = (
  ...
  switch (formula) {
    case 'area_m2':
      return dimensions.areaM2 * multiplier;
    case 'perimeter_lm':
      return dimensions.perimeterLm * multiplier;
    case 'wall_area_m2':
      return dimensions.wallAreaM2 * multiplier;
    case 'ceiling_area_m2':
      return dimensions.ceilingAreaM2 * multiplier;
    case 'fixed':
      return 1 * multiplier;
    case 'room_count':
      return 1 * multiplier;
...
export const calculateItemizedEstimate = (input: ProjectInput): ItemizedEstimateResult => {
  ...
  const projectMultiplier =
    propertyTypeMultiplier * conditionMultiplier * accessMultiplier * urgencyMultiplier;
