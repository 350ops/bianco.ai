...
const masonryVideos = [
  {
    id: '1',
    uri: 'https://images.unsplash.com/photo-1656381620321-bddff61435c3?q=80&w=1015&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    height: 200,
    isVideo: true,
  },
  {
    id: '2',
    uri: 'https://images.unsplash.com/photo-1505506874110-6a7a69069a08?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c3BhY2V8ZW58MHx8MHx8fDA%3D',
    height: 250,
    isVideo: true,
  },
  {
    id: '3',
    uri: 'https://images.unsplash.com/photo-1484589065579-248aad0d8b13?q=80&w=1359&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    height: 200,
    isVideo: true,
  },
  {
    id: '4',
    uri: 'https://images.unsplash.com/photo-1457364887197-9150188c107b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    height: 200,
    isVideo: true,
  },
];
    ...
    <>
      <View className="p-global">
        <View className="flex-col items-center justify-between">
          ...
          <ThemedText className="mt-4 text-xl font-bold">Thomino</ThemedText>
          <ThemedText className="text-sm opacity-50">Vibe crafting AI visuals</ThemedText>
        </View>
        <View className="mx-auto mt-6 flex-row items-center justify-center gap-10 rounded-2xl bg-secondary p-4">
...
const UserActionsSheet = React.forwardRef<ActionSheetRef>((props, ref) => {
  return (
    <ActionSheetThemed gestureEnabled ref={ref}>
      <View className="p-global">
        <View className="mb-4 rounded-2xl bg-background">
...
const SheetItem = (props: any) => {
  return (
    <Pressable className="flex-row items-center justify-between  rounded-2xl border-b border-border p-4">
      <ThemedText className="text-base font-semibold">{props.name}</ThemedText>
