          ...
          <ScrollView className="p-4">
            {options.map((option) => (
              <Pressable
                ...
                className={`mb-2 rounded-xl p-4 ${selectedValue === option ? 'bg-highlight' : ''}`}
                style={
                ...
                <ThemedText className={selectedValue === option ? 'font-semibold text-white' : ''}>
                  {option}
                </ThemedText>
              </Pressable>
            ))}
          ...
          <ScrollView className="px-6 py-4">
            {estimateResult && (
              <>
                ...
                {/* AR Scan Data */}
                <View className="mb-6">
                  <ThemedText className="mb-3 font-semibold">Scanned Room Data</ThemedText>
                  <View
                    className="rounded-xl p-4"
                    style={{
                      backgroundColor: colors.isDark
                ...
                <View className="mb-6 rounded-xl border border-border p-4">
                  <ThemedText className="text-light-subtext dark:text-dark-subtext text-center text-xs leading-relaxed">
                    This estimate is based on your AR room scan measurements. Actual costs may vary
                    based on specific requirements and local rates.
                  </ThemedText>
                </View>
              </>
            )}
    ...
    <View className="flex-1 bg-background">
      ...
      <View className="px-global pb-4 pt-4" style={{ paddingTop: insets.top + 10 }}>
        <View className="mb-6 flex-row items-center">
          ...
          <ThemedText className="flex-1 pr-12 text-center text-xl font-semibold">
            {getStepTitle()}
          </ThemedText>
        </View>
        <ProgressBar />
