...
export default function OnboardingScreen() {
    ...
    return (
        <View className='flex-1 bg-background'>
            <ImageBackground
                source={require('@/assets/img/onboarding-start.jpg')}
            ...
            >
                <View style={{ bottom: insets.bottom }} className="flex-1 px-10 relative items-start justify-end">
                    ...
                    <ThemedText className='text-white text-lg'>We are excited to have you on board. Let's set up your account.</ThemedText>
