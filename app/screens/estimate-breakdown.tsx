...
export default function EstimateBreakdownScreen() {
  ...
  const TabButton = ({ mode, label, icon }: { mode: ViewMode; label: string; icon: IconName }) => (
    <Pressable
      ...
      style={[styles.tabButton, viewMode === mode && { backgroundColor: PRIMARY_BLUE }]}>
      <Icon name={icon} size={16} color={viewMode === mode ? '#fff' : colors.text} />
      <ThemedText style={[styles.tabLabel, { color: viewMode === mode ? '#fff' : colors.text }]}>
        {label}
      </ThemedText>
    </Pressable>
  );
              ...
              <View key={idx} style={styles.lineItemRow}>
                <View style={styles.lineItemInfo}>
                  ...
                  <ThemedText style={[styles.lineItemQty, { color: colors.placeholder }]}>
                    ...
                    {formatCurrency(item.unitCostFinal)}
                  </ThemedText>
                </View>
          ...
          <View style={styles.expandedRoom}>
            ...
            <View style={styles.splitRow}>
              ...
              <View
                ...
                <ThemedText style={styles.splitValue}>{formatCurrency(room.laborCost)}</ThemedText>
              </View>
            </View>
    ...
    <View className="flex-1 bg-background">
      ...
      <View className="px-global pb-4 pt-4" style={{ paddingTop: insets.top + 10 }}>
        <View className="mb-4 flex-row items-center">
          ...
          <ThemedText className="flex-1 text-xl font-semibold">Estimate Breakdown</ThemedText>
        </View>
      ...
      <ScrollView
              ...
              <LiquidGlassCard style={{ marginTop: 20 }}>
                <View style={styles.assumptionsCard}>
                  ...
                  <View style={styles.assumptionRow}>
                    ...
                    <ThemedText>
                      {estimateData.inputSummary.city}, {estimateData.inputSummary.country}
                    </ThemedText>
                  </View>
                  <View style={styles.assumptionRow}>
                    <ThemedText style={[styles.assumptionLabel, { color: colors.placeholder }]}>
                    ...
                    <ThemedText>
                      {estimateData.inputSummary.propertyType} (×
                      {estimateData.multipliers.propertyType?.value?.toFixed(2) || '1.00'})
                    </ThemedText>
                  </View>
                  <View style={styles.assumptionRow}>
                    <ThemedText style={[styles.assumptionLabel, { color: colors.placeholder }]}>
                  ...
                  <View style={styles.assumptionRow}>
                    ...
                    <ThemedText>
                      ×{estimateData.multipliers.accessDifficulty?.value?.toFixed(2) || '1.00'}
                    </ThemedText>
                  </View>
                  <View style={styles.assumptionRow}>
                    <ThemedText style={[styles.assumptionLabel, { color: colors.placeholder }]}>
                    ...
                    <ThemedText>
                      ×{estimateData.multipliers.urgency?.value?.toFixed(2) || '1.00'}
                    </ThemedText>
                  </View>
                </View>
              </LiquidGlassCard>
            ...
            <LiquidGlassCard style={{ marginTop: 16 }}>
              <View style={styles.assumptionsCard}>
                ...
                <View style={styles.assumptionRow}>
                  ...
                  <ThemedText>
                    {(estimateData.assumptions.wallOpeningsPct * 100).toFixed(0)}%
                  </ThemedText>
                </View>
                <View style={styles.assumptionRow}>
                  <ThemedText style={[styles.assumptionLabel, { color: colors.placeholder }]}>
                  ...
                  <ThemedText>
                    {(estimateData.assumptions.overheadPct * 100).toFixed(0)}%
                  </ThemedText>
                </View>
                <View style={styles.assumptionRow}>
                  <ThemedText style={[styles.assumptionLabel, { color: colors.placeholder }]}>
                  ...
                  <ThemedText>
                    {(estimateData.assumptions.contingencyPct * 100).toFixed(0)}%
                  </ThemedText>
                </View>
                <View style={styles.assumptionRow}>
                  <ThemedText style={[styles.assumptionLabel, { color: colors.placeholder }]}>
                      ...
                      <View style={styles.lineItemNameRow}>
                        <View
                          style={[
                            ...
                            {
                              backgroundColor:
                                item.costType === 'material' ? '#A9CC9C25' : `${PRIMARY_BLUE}25`,
                            },
                          ]}>
                          <ThemedText
                            style={[
        ...
        <View style={styles.disclaimer}>
          <ThemedText style={[styles.disclaimerText, { color: colors.placeholder }]}>
            This is an itemized estimate based on standard rates. Actual costs may vary based on
            specific site conditions, material availability, and contractor quotes. Pricing version:{' '}
            {estimateData.pricingVersion}
          </ThemedText>
        </View>
      </ScrollView>
    </View>
