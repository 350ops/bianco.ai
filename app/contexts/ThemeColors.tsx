...
export const useThemeColors = () => {
  ...
  return {
    ...
    state: isDark ? 'rgba(77, 163, 225, 0.35)' : 'rgb(34, 92, 209)',

    faded: isDark ? 'rgba(0,0,0,0.9)' : 'rgba(74, 143, 222, 0.96)',

    sheet: isDark ? '#2A2A2A' : '#FFFFFF',

    highlight: isDark ? '#4DA3E1' : '#007334',

    border: isDark ? 'rgba(255,255,255,0.15)' : 'rgba(72, 72, 72, 0.15)',

    text: isDark ? '#ffffff' : '#484848',

    placeholder: isDark ? 'rgba(255,255,255,0.4)' : 'rgba(72, 72, 72, 0.5)',

    switch: isDark ? '#4DA3E1' : '#4DA3E1',

    chatBg: isDark ? '#1A1A1A' : '#FFFFFF',

    // Accent system - Blue primary
    accent: '#000000',
    accentLight: isDark ? 'rgba(0, 0, 0, 0.25)' : 'rgba(100, 225, 146, 0)',
    iconAccent: '#007334',
    iconBg: isDark ? 'rgba(255, 229, 160, 0.2)' : '#FFF3D6', // Pastel yellow for icon backgrounds
