...
export const FEATURED_DESIGNS: FeaturedDesign[] = [
  ...
  },
  {
    ...
    keyElements: ['Floating nightstands', 'Linen bedding', 'Wall sconces', 'Flush closet doors'],
  ...
  },
  {
    ...
    keyElements: ['Frameless glass shower', 'Stone-look tile', 'Backlit mirror', 'Floating vanity'],
