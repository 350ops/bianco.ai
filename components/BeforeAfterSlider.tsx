    ...
    <GestureHandlerRootView style={{ flex: 0 }}>
      <GestureDetector gesture={panGesture}>
        <View style={[styles.container, { width, height, borderRadius }]}>
          ...
          <Animated.View
            style={[styles.beforeContainer, animatedClipStyle, { height, borderRadius }]}>
            <Image
              source={beforeSource}
              style={[styles.image, { width, height, borderRadius }]}
              resizeMode="cover"
          ...
          <Animated.View style={[styles.sliderLine, animatedSliderStyle, { height }]}>
            ...
            <View style={[styles.handle, { backgroundColor: activeSliderColor }]}>
              <View style={styles.handleInner}>
                <View
                  style={[styles.arrow, styles.arrowLeft, { borderRightColor: activeSliderColor }]}
                />
                <View
                  style={[styles.arrow, styles.arrowRight, { borderLeftColor: activeSliderColor }]}
                />
              </View>
            </View>
          </Animated.View>
