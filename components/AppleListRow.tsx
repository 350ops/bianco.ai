              ...
              {subtitle && (
                <ThemedText
                  style={[
                    styles.subtitle,
                    {
                      color: colors.isDark ? 'rgba(255,255,255,0.5)' : 'rgba(60,60,67,0.6)',
                    },
                  ]}>
                  {subtitle}
                </ThemedText>
                ...
                {showChevron && (
                  <ThemedText
                    style={[
                      styles.chevron,
                      {
                        color: colors.isDark ? 'rgba(255,255,255,0.3)' : 'rgba(60,60,67,0.3)',
                      },
                    ]}>
                    ›
                  </ThemedText>
...
export function AppleListGroup({ children, header, footer, useGlass = true }: AppleListGroupProps) {
  ...
  const containerContent = <>{enhancedChildren}</>;
  ...
  return (
    <View style={styles.groupContainer}>
      ...
      {shouldUseGlass ? (
        <GlassView style={[styles.groupContent, styles.glassContainer]} glassEffectStyle="regular">
          {containerContent}
        </GlassView>
      ) : (
        <View
          style={[
            styles.groupContent,
            {
              backgroundColor: colors.isDark ? 'rgba(255,255,255,0.08)' : '#FFFFFF',
              borderRadius: 12,
              overflow: 'hidden',
            },
          ]}>
