import { Host, HStack, LinearProgress, Slider, Text as UIText, VStack } from '@expo/ui/swift-ui';
  ...
  return (
    <Host matchContents>
      <VStack modifiers={[background('#FFF'), cornerRadius(16)]}>
        ...
        <LinearProgress
          progress={(fromSadToHappyStrings.indexOf(mood) + 1) / (fromSadToHappyStrings.length - 1)}
          color={
