    ...
    <ScrollView
      ...
      <View style={styles.statsContainer}>
        <View
          ...
          <Text style={[styles.statNumber, { color: theme.warning }]}>{getTotalStreak()}</Text>
        ...
        <View
          ...
          <Text style={[styles.statLabel, { color: theme.textSecondary }]}>Week Progress</Text>
        </View>
        <View
          style={[
            styles.statCard,
          ...
          <Text style={[styles.statLabel, { color: theme.textSecondary }]}>Active Habits</Text>
        </View>
      </View>
        ...
        <View
          ...
          <View style={styles.habitInfo}>
            <View style={styles.habitHeader}>
              <View
                style={[styles.habitNumberContainer, { backgroundColor: theme.primary + '20' }]}>
                <Text style={[styles.habitNumber, { color: theme.primary }]}>{habitIndex + 1}</Text>
              </View>
              <View style={styles.habitTitleContainer}>
                ...
                <View style={styles.habitMeta}>
                  ...
                  <View style={[styles.percentageBadge, { backgroundColor: theme.success + '20' }]}>
