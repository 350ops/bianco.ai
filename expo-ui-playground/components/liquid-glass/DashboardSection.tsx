...
export function DashboardSection() {
  const { tasks, productivityScore, setProductivityScore, focusLevel, setFocusLevel } = use(
    AppContext
  ) as AppState;
        ...
        <VStack spacing={12}>
          ...
          <VStack spacing={8}>
            ...
            <VStack spacing={4}>
              ...
              <Gauge current={{ value: completionRate }} color="green" type="default" />
            </VStack>
            ...
            <VStack spacing={4}>
              ...
              <Gauge current={{ value: productivityScore }} color="blue" type="linear" />
            </VStack>
            ...
            <VStack spacing={4}>
              ...
              <Gauge current={{ value: focusLevel }} color="purple" type="linearCapacity" />
            </VStack>
